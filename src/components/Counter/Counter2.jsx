...
const Counter2 = memo(function Counter2({ initialCount }) {
  log('<Counter2 /> rendered', 1);
  ...
  //viene eseguito quando cambia initialCount
  //useEffect(() =>{setCounterChanges([{value: initialCount, id: Math.random()*1000}]);}, [initialCount]);
  //non è ottimale, meglio usare la key quando si una il componente
